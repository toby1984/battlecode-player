...
public final class FastRandom
{
    ...
    public final class InternalState {
        ...
        public InternalState() {
        	this.currentSeed = FastRandom.this.currentSeed;
        	this.nextNextGaussian = FastRandom.this.nextNextGaussian;
        	this.haveNextNextGaussian = FastRandom.this.haveNextNextGaussian;
        }
        
        protected void apply(FastRandom r) {
        	r.currentSeed = this.currentSeed;
        	r.nextNextGaussian = this.nextNextGaussian;
        	r.haveNextNextGaussian = this.haveNextNextGaussian;
        }
    }
    ...
    public void restoreState(InternalState state) {
    	state.apply(this);
    }
